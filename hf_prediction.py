...
new_df['ExerciseAngina'].replace(['Yes','No'],[1.0, 0.0], inplace = True)
new_df['ST_Slope_Up'].replace(['Up','Flat','Slop'],[1.0, 0.0, 0.0], inplace = True)
new_df['ST_Slope_Flat'].replace(['Up','Flat','Slop'],[0.0, 1.0, 0.0], inplace = True)
new_df['ST_Slope_Down'].replace(['Up','Flat','Slop'],[0.0, 0.0, 1.0], inplace = True)
